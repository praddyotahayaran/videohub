...
const VideosJs = () => {
    ...
    return (
        <Stack direction={["column", "row"]} h={"100vh"}>
            <VStack w={"full"}>
                <video controls controlsList='nodownload' src={videosSrc} style={{ width: "100%" }}>
                </video>

                <VStack alignItems={"flex-start"} p="8" w={"full"} overflowX={"auto"}>
                    <Heading>Video 1</Heading>
                    <Text>This is a sample video for esting & demo. This is
                        called description. Hey there we are working on react tutorial
                        as we have the full
                        reactjs</Text>
                </VStack>
            </VStack>
